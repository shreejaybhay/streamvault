    ...
    <Link href={`/shows/${show.id}`}>
      ...
      >
        ...
        <div className="flex flex-col flex-grow p-4">
          <p className="font-medium transition-colors duration-300 line-clamp-1 group-hover:text-primary">
            {show.name}
          </p>
...
const ShowDetailsPage = () => {
  ...
  useEffect(() => {
    if (id && selectedSeason && selectedEpisode) {
      setShowEmbedUrl(`https://cinesrc.st/embed/tv/${id}?s=${selectedSeason}&e=${selectedEpisode}`)
    }
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 p-4 sm:p-6 md:p-12">
                  <div className="flex flex-col items-start gap-4 md:flex-row md:items-end sm:gap-6 md:gap-8">
                    ...
                    <div className="flex-1 space-y-4 sm:space-y-6">
                      ...
                      {/* Overview skeleton - fewer lines on mobile */}
                      ...
                      {/* Buttons skeleton - adaptive for mobile */}
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 sm:gap-8">
              ...
              <div className="space-y-4 md:col-span-2 sm:space-y-6">
                ...
                <div className="p-4 border shadow-lg bg-base-200/80 backdrop-blur-sm rounded-xl sm:rounded-2xl sm:p-6 border-base-content/5">
                  ...
                  {/* Episodes grid skeleton - adaptive columns */}
                  <div className="grid grid-cols-1 gap-3 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 sm:gap-4">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="rounded-lg aspect-video bg-base-300 animate-pulse"></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="p-4 border shadow-lg bg-base-200/80 backdrop-blur-sm rounded-xl sm:rounded-2xl sm:p-6 border-base-content/5">
                  ...
                  {/* Cast grid skeleton - adaptive for mobile */}
      ...
      <div className="container px-4 py-8 mx-auto">
          ...
          <div className="space-y-8">
                ...
                <div className="relative h-[50vh] xs:h-[55vh] sm:h-[60vh] md:h-[70vh] w-full overflow-hidden rounded-xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 z-20 p-4 sm:p-6 md:p-12">
                    <div className="flex flex-col items-start gap-4 md:flex-row md:items-end sm:gap-6 md:gap-8">
                      ...
                      {/* Anime details with improved typography and spacing */}
                      <div className="flex-1 text-white">
                        ...
                        {/* Anime metadata with improved badges */}
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 md:grid-cols-3">
              ...
              <div className="space-y-6 md:col-span-2">
                ...
                <div className="p-6 transition-all duration-300 border shadow-lg bg-base-200/80 backdrop-blur-sm rounded-2xl border-base-content/5 hover:shadow-xl">
                  ...
                  <div className="grid grid-cols-2 gap-6 md:grid-cols-3">
                    <div className="p-4 transition-all duration-300 bg-base-100/50 rounded-xl hover:bg-base-100 hover:shadow-md group">
                      <h3 className="mb-1 text-sm font-medium transition-colors text-base-content/60 group-hover:text-primary">
                        Status
                      </h3>
                      <p className="font-semibold text-base-content">{show.status || "N/A"}</p>
                    </div>
                    <div className="p-4 transition-all duration-300 bg-base-100/50 rounded-xl hover:bg-base-100 hover:shadow-md group">
                      <h3 className="mb-1 text-sm font-medium transition-colors text-base-content/60 group-hover:text-primary">
                        First Air Date
                      </h3>
                      <p className="font-semibold text-base-content">{formatDate(show.first_air_date)}</p>
                    </div>
                    <div className="p-4 transition-all duration-300 bg-base-100/50 rounded-xl hover:bg-base-100 hover:shadow-md group">
                      <h3 className="mb-1 text-sm font-medium transition-colors text-base-content/60 group-hover:text-primary">
                        Episodes
                      </h3>
                      <p className="font-semibold text-base-content">{show.number_of_episodes || "N/A"}</p>
                    </div>
                    <div className="p-4 transition-all duration-300 bg-base-100/50 rounded-xl hover:bg-base-100 hover:shadow-md group">
                      <h3 className="mb-1 text-sm font-medium transition-colors text-base-content/60 group-hover:text-primary">
                        Seasons
                      </h3>
                      <p className="font-semibold text-base-content">{show.number_of_seasons || "N/A"}</p>
                    </div>
                    <div className="p-4 transition-all duration-300 bg-base-100/50 rounded-xl hover:bg-base-100 hover:shadow-md group">
                      <h3 className="mb-1 text-sm font-medium transition-colors text-base-content/60 group-hover:text-primary">
                        Network
                      </h3>
                      <p className="font-semibold text-base-content">{show.networks?.[0]?.name || "N/A"}</p>
                    </div>
                    <div className="p-4 transition-all duration-300 bg-base-100/50 rounded-xl hover:bg-base-100 hover:shadow-md group">
                      <h3 className="mb-1 text-sm font-medium transition-colors text-base-content/60 group-hover:text-primary">
                        Original Language
                ...
                {show?.seasons && show.seasons.length > 0 && (
                  <div className="p-6 mt-6 transition-all duration-300 border shadow-lg bg-base-200/80 backdrop-blur-sm rounded-2xl border-base-content/5 hover:shadow-xl">
                    ...
                    <div className="relative mb-6">
                      ...
                      <button
                        className="absolute left-0 z-50 p-2 -ml-3 transition-all duration-300 -translate-y-1/2 rounded-full shadow-lg top-1/2 bg-base-100/90 hover:bg-primary/90 text-base-content hover:text-primary-content"
                      ...
                      <button
                        className="absolute right-0 z-50 p-2 -mr-3 transition-all duration-300 -translate-y-1/2 rounded-full shadow-lg top-1/2 bg-base-100/90 hover:bg-primary/90 text-base-content hover:text-primary-content"
                    ...
                    {selectedSeason && (
                      <div className="space-y-4">
                        <div className="sticky z-40 p-3 mb-6 border shadow-lg top-4 bg-base-100/95 backdrop-blur-sm rounded-xl border-base-content/10">
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    {totalPages > 5 && currentEpisodePage < totalPages - 2 && (
                                      <>
                                        ...
                                        <button
                                          ...
                                          className="px-3 py-1 transition-colors rounded-md bg-base-300 hover:bg-base-100"
                                        >
                                          {totalPages}
                                        </button>
                                      </>
                                  ...
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <div className="relative">
                                      ...
                                      `}</style>
                                      <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none text-base-content/70">
                              ...
                              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                                {Array.from(
                                  ...
                                  >
                                    ...
                                    <div className="absolute bottom-0 w-0 h-1 transition-all duration-300 transform -translate-x-1/2 rounded-full opacity-0 left-1/2 bg-accent group-hover:w-1/2 group-hover:opacity-100"></div>
                                  </button>
                                ))}
                              </div>
                            </>
              ...
              <div className="md:col-span-1">
                <div className="flex flex-col h-full p-6 transition-all duration-300 border shadow-lg bg-base-200/80 backdrop-blur-sm rounded-2xl border-base-content/5 hover:shadow-xl">
                  <h2 className="flex items-center justify-between pb-3 mb-5 text-xl font-semibold border-b border-base-content/10">
                  ...
                  <div className="flex-grow mb-4 space-y-2 overflow-y-auto">
                    {cast.slice(0, 11).map((actor, index) => (
                      <div
                        key={index}
                        className="relative flex items-center p-3 transition-all duration-300 border group rounded-xl bg-base-100/50 hover:bg-base-100 hover:shadow-md border-base-content/5"
                        style={{
                          transform: "translateZ(0)",
                          willChange: "transform",
                          isolation: "isolate",
                      ...
                      >
                        <div className="relative flex-shrink-0 w-12 h-12 mr-3 overflow-hidden transition-all duration-300 border-2 rounded-full shadow-sm border-primary/20 group-hover:border-primary/40">
                          <img
                            src={
                              actor.profile_path
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium truncate transition-colors duration-300 text-base-content group-hover:text-primary">
                            {actor.name}
                          </p>
                          <p className="text-xs truncate text-base-content/70">{actor.character}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <Link
                    href={`/shows/${id}/cast`}
                    className="flex items-center justify-center w-full gap-2 px-4 py-3 mt-auto font-medium transition-all duration-300 border bg-base-100 hover:bg-base-100/80 text-primary rounded-xl hover:shadow-md group border-primary/10 hover:border-primary/30"
                  >
            ...
            {showModal && (
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 transition-all duration-300 bg-black/90 backdrop-blur-md animate-in fade-in">
                <div
                ...
                >
                  ...
                  >
                    <MdClose size={22} className="transition-transform duration-300 group-hover:rotate-90" />
                  </button>

                  <div className="absolute bottom-0 left-0 right-0 z-20 flex items-center h-16 px-4 pointer-events-none bg-gradient-to-t from-black/70 to-transparent">
                    <h3 className="font-medium text-white truncate text-shadow-sm">{show.name} - Official Trailer</h3>
                  </div>
        ...
        {similarShows.length > 0 && (
          <div className="mt-12">
            ...
            <div className="p-4 transition-all duration-300 border shadow-lg bg-base-200/80 backdrop-blur-sm rounded-2xl md:p-6 border-base-content/5 hover:shadow-xl">
              ...
              <div className="md:hidden">
                <Slider {...sliderSettings}>
                  {similarShows.map(similarShow => (
                    <div key={similarShow.id} className="px-2">
                      <ShowCard show={similarShow} genreMap={genreMap} />
                    </div>
                  ))}
                </Slider>
              </div>
